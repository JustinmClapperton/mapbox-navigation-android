...
class MapboxRouteLineApiTest {
    ...
    fun getHidePrimaryRouteState() {
        ...
        assertEquals(
            result.value.getLayerVisibilityChanges()[0].first,
        ...
        assertEquals(
            result.value.getLayerVisibilityChanges()[2].first,
    ...
    fun setRoutes() {
        ...
        assertEquals(
            ...
            result.value.getTrafficLineExpression().toString()
        )
        assertEquals(
    ...
    fun findClosestRoute_whenClickPoint() = runBlockingTest {
        ...
        assertEquals(1, result.value.getRouteIndex())
    ...
    fun findClosestRoute_whenPrimaryRoute() = runBlockingTest {
        ...
        assertEquals(0, result.value.getRouteIndex())
        unmockkStatic(UUID::class)
    }
